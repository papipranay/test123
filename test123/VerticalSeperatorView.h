...
@interface VerticalSeperatorView : UIView
@property (nonatomic, strong) NSLayoutConstraint *leftConstraint;      // the constraint that dictates the vertical position of the separator
...
@property (nonatomic) CGFloat oldX;                                   // the position of the separator before the gesture started
